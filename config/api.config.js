...
module.exports = {
  ...
  clientId: process.env.NEXT_PUBLIC_CLIENT_ID || 'example_client_id',
  obfuscatedClientSecret: process.env.NEXT_PUBLIC_OBFUSCATED_CLIENT_SECRET || 'example_obfuscated_client_secret',
